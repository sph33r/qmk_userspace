...
[_WIN] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_HOME, LOWER,   KC_SPC,  KC_SPC,  RAISE,   MEH(KC_NO), KC_LEFT, KC_RIGHT, KC_ENT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_END, _______, _______, _______, _______, _______, KC_UP,   KC_DOWN, _______
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    RM_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT
)
