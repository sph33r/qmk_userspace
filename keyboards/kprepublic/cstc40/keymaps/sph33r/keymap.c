...
[_WIN] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_HOME, LOWER,   KC_SPC,  RAISE,   MEH(KC_NO), KC_LEFT, KC_RIGHT, KC_ENT
),
...
[_MAC] = LAYOUT_planck_mit(
    ...
    LT(_RAISE, KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
    SC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  SC_RSPC,
    KC_LCTL, KC_LOPT, KC_LCMD, AP_GLOB, LOWER,   KC_SPC,  RAISE,   HYPR(KC_NO), KC_LEFT, KC_RIGHT, KC_ENT
),
...
[_ADJUST] = LAYOUT_planck_mit(
    ...
    RM_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT
)
